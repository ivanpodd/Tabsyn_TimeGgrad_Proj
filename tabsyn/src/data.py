...
def prepare_torch_dataloader(
    ...
    torch_dataset = TabDataset(dataset, split)
    loader = torch.utils.data.DataLoader(torch_dataset, batch_size=batch_size, shuffle=False, num_workers=1)
...
def prepare_fast_dataloader(
    ...
    dataloader = FastTensorDataLoader(X, batch_size=batch_size, shuffle=False)
    while True:
